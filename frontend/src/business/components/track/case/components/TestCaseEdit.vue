    ...
    <div class="card-content">
      <div class="ms-main-div" @click="showAll">
        ...
        <div class="ms-opt-btn">
          ...
          <el-dropdown v-else split-button type="primary" class="ms-api-buttion" @click="handleCommand"
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="ADD_AND_CREATE">{{ $t('test_track.case.save_create_continue') }}
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
        <el-form :model="form" :rules="rules" ref="caseFrom" v-loading="result.loading" class="case-form">
          ...
          <form-rich-text-item v-if="form.stepModel !== 'Cucumber'" :disabled="readOnly" :label-width="formLabelWidth"
          ...
          <el-form-item :label-width="formLabelWidth" label="Scenario" prop="stepDescription"
            ...
            <ms-code-edit :mode="mode" height="400px" :read-only="readOnly" :data.sync="form.stepDescription"
                          :modes="modes" ref="codeEdit"/>
          </el-form-item>

          <test-case-step-item :label-width="formLabelWidth" v-if="form.stepModel === 'STEP'" :form="form"
                               :read-only="readOnly"/>
