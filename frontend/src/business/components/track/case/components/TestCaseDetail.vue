  ...
  <el-row :gutter="5">
    <el-col :span="15">
      <el-card class="case-detail-form-card">
        <el-form ref="caseFrom" v-loading="result.loading" :model="form">
          <el-row>
          ...
          <el-row>
            <el-col :span="10" :offset="1">
              <el-form-item
                :label="$t('test_track.case.maintainer')"
                :label-width="formLabelWidth"
                prop="maintainer"
              >
                <el-select
                  v-model="testCase.maintainer"
                  :disabled="readOnly"
                  :placeholder="$t('test_track.case.input_maintainer')"
                  filterable
                >
                </el-select>
              </el-form-item>
            ...
            <el-col :span="12">
              ...
              >
                <el-select
                  ...
                  :disabled="readOnly"
                  :placeholder="$t('test_track.case.input_method')"
                >
                  <el-option
                    :label="$t('test_track.case.auto')"
                    value="auto"
                  ></el-option>
                  <el-option
                    :label="$t('test_track.case.manual')"
                    value="manual"
                  ></el-option>
                </el-select>
              </el-form-item>
          ...
          <el-row v-if="testCase.method && testCase.method == 'auto'">
            <el-col :span="10" :offset="1">
              <el-form-item
                :label="$t('test_track.case.relate_test')"
                :label-width="formLabelWidth"
                prop="testId"
              >
                <el-select
                  v-model="testCase.testId"
                  filterable
                  :disabled="readOnly"
                  :placeholder="$t('test_track.case.input_type')"
                >
            ...
            <el-col v-if="testCase.testId == 'other'" :span="12">
              <el-form-item
                :label="$t('test_track.case.test_name')"
                :label-width="formLabelWidth"
                prop="testId"
              >
                <el-input
                  v-model="testCase.otherTestName"
                  :placeholder="$t('test_track.case.input_test_case')"
                  :disabled="readOnly"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row style="margin-top: 15px">
            <el-col :offset="1"
              >{{ $t("test_track.case.prerequisite") }}:</el-col
            >
          </el-row>
          ...
          <el-row
            v-if="testCase.method && testCase.method != 'auto'"
