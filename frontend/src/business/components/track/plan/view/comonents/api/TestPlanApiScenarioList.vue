<template>
  <div class="card-container">
    <el-card v-loading="loading" class="card-content">
  ...
  methods: {
    search() {
      ...
      if (this.reviewId) {
        ...
        let url =
          "/test/case/review/scenario/case/list/" +
          this.currentPage +
          "/" +
          this.pageSize;
        this.$post(url, this.condition, (response) => {
          ...
          callback: (action) => {
            if (action === "confirm") {
              ...
              if (this.planId) {
                ...
                this.$post(
                  "/test/plan/scenario/case/batch/delete",
                  param,
                  () => {
                    this.$refs.table.selectRows.clear();
                    this.search();
              ...
              if (this.reviewId) {
                ...
                this.$post(
                  "/test/case/review/scenario/case/batch/delete",
                  param,
                  () => {
                    this.$refs.table.selectRows.clear();
                    this.search();
    ...
    handleBatchEdit() {
      if (this.condition != null && this.condition.selectAll) {
        ...
        this.$post(
          "/test/plan/scenario/case/selectAllTableRows",
          selectAllRowParams,
          (response) => {
