        ...
        <el-tabs v-model="activeName">
          <el-tab-pane :label="$t('schedule.task_config')" name="first">
            ...
            >
              ...
              <crontab-result ref="crontabResult" :ex="form.cronValue" />
            </el-form>
            ...
            <div v-if="runConfig.mode === 'serial'" class="ms-mode-div">
              <el-row>
                <el-col :span="3">
                ...
                <el-col :span="18">
                  ...
                  <div
                    v-if="scheduleTaskType === 'TEST_PLAN_TEST'"
            ...
            <div v-if="runConfig.mode === 'parallel'" class="ms-mode-div">
              <el-row>
                <el-col :span="3">
                  <span class="ms-mode-span"
                    >{{ $t("run_mode.other_config") }}:</span
...
const noticeTemplate =
  requireComponent.keys().length > 0
    ? requireComponent("./notice/NoticeTemplate.vue")
    : {};
  ...
  methods: {
        ...
        this.$confirm(
          ...
          this.$t("commons.prompt"),
          {
            ...
            beforeClose(action, instance, done) {
              if (action === "cancel") {
                //  否则在 messageBox 点击取消后，switch 按钮仍然会被关闭
    ...
    updateTask(param) {
      this.result = this.$post(
        "/api/schedule/updateEnableByPrimyKey",
        param,
        (response) => {
          let paramTestId = "";
    ...
    findSchedule() {
      ...
      this.result = this.$get(
        "/schedule/findOne/" + scheduleResourceID + "/" + taskType,
        (response) => {
