...
import SyncTestCase from "@/business/components/track/case/components/SyncTestCase";
  ...
  data() {
    return {
      ...
      operators: [
        ...
        {
          label: this.$t("test_track.sync_jira_test_case"),
          callback: this.syncJiraTestCase,
          permissions: ["PROJECT_TRACK_CASE:READ+CREATE"],
        },
      ],
    };
