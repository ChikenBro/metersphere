...
export default {
  ...
  methods: {
    ...
    getList(type, name = "") {
      ...
      // // mock数据
      this.defectList = [
        { id: 30801759, name: "功能缺陷", statusName: null, statusType: null },
        {
          id: 30801760,
          name: "UI 界面问题",
          statusName: null,
        ...
        { id: 30801762, name: "安全问题", statusName: null, statusType: null },
        { id: 30801763, name: "性能问题", statusName: null, statusType: null },
