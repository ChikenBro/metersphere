      ...
      <el-main style="padding-left: 0px; padding-right: 0px">
        <div style="width: 200px; margin: 0 auto">
          <el-row align="center">
            ...
            >
              <div
                class="count-info-div"
                v-html="trackCountData.p0CountStr"
              ></div>
            </el-col>
            <el-col
              :span="6"
            ...
            >
              <div
                class="count-info-div"
                v-html="trackCountData.p1CountStr"
              ></div>
            </el-col>
            <el-col
              :span="6"
            ...
            >
              <div
                class="count-info-div"
                v-html="trackCountData.p2CountStr"
              ></div>
            </el-col>
            <el-col :span="6" style="padding: 5px">
              <div
                class="count-info-div"
                v-html="trackCountData.p3CountStr"
              ></div>
            </el-col>
          </el-row>
        ...
        <el-row>
          <el-col>
            ...
            <el-link
              ...
              target="_blank"
              style="color: #000000"
              @click="redirectPage('thisWeekCount')"
              ...
              >
                <span class="count-number">
                  ...
                  <el-tooltip placement="top" class="info-tool-tip">
                    <div slot="content">
                      {{ $t("api_test.home_page.formula.review") }}
                    </div>
                    <el-button
                      icon="el-icon-info"
