  ...
  children: [
    {
      ...
      name: "fucHome",
      component: () =>
        import("@/business/components/api/homepage/ApiTestHomePage"),
    },
    {
      path: "home_obsolete",
      name: "fucHome",
    ...
    },
    {
      ...
      name: "ApiReportList",
      component: () =>
        import("@/business/components/api/automation/report/ApiReportList"),
    },
    {
      path: "automation/report/view/:reportId",
      name: "ApiReportView",
      component: () =>
        import("@/business/components/api/automation/report/ApiReportView"),
    },
    {
      path: "definition/:redirectID?/:dataType?/:dataSelectRange?",
      name: "ApiDefinition",
      component: () =>
        import("@/business/components/api/definition/ApiDefinition"),
    },
    {
      path: "automation/:redirectID?/:dataType?/:dataSelectRange?",
      name: "ApiAutomation",
      component: () =>
        import("@/business/components/api/automation/ApiAutomation"),
    },
    {
      path: "monitor/view",
      name: "ApiMonitor",
