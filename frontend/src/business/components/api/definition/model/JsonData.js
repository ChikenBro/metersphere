...
export const CASE_ORDER = [
  {
    label: "api_test.definition.request.grade_order_asc",
    name: "priority",
    type: "desc",
    id: "grade_order_asc",
  },
  {
    label: "api_test.definition.request.grade_order_desc",
    name: "priority",
    type: "asc",
    id: "grade_order_desc",
  },
...
export const TCP_METHOD = [{ id: "TCP", label: "TCP" }];
export const SQL_METHOD = [{ id: "SQL", label: "SQL" }];
export const DUBBO_METHOD = [{ id: "dubbo://", label: "dubbo://" }];
