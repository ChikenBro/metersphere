<template>
  <el-menu
    ...
    class="setting"
  >
    <el-submenu v-permission="systemPermission" index="1">
    ...
    <el-submenu
      v-permission="[
        ...
        'ORGANIZATION_WORKSPACE:READ',
        'ORGANIZATION_SERVICE:READ',
        'ORGANIZATION_MESSAGE:READ',
        'ORGANIZATION_OPERATING_LOG:READ',
      ]"
      index="2"
    >
      <template v-slot:title>
