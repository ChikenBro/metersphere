  ...
  <div v-loading="result.loading">
    <el-card class="table-card">
              ...
              <el-col :span="5">
                <el-form-item :label="$t('operating_log.time')" prop="times">
                  <el-date-picker
                    ...
                    :end-placeholder="$t('variables.end')"
                    style="width: 100%"
                  >
                  </el-date-picker>
                </el-form-item>
      ...
      >
        ...
        <el-table-column
          prop="operModule"
          :label="$t('operating_log.object')"
          show-overflow-tooltip
          width="120px"
        />
        <el-table-column
          prop="operTitle"
          :label="$t('operating_log.name')"
          show-overflow-tooltip
          width="150px"
        />
        <el-table-column :label="$t('report.test_log_details')">
          <template v-slot:default="scope">
            <el-link style="color: #409eff" @click="openDetail(scope.row)">{{
  ...
  data() {
    return {
      ...
      LOG_TYPE: [
        {
          id: "CREATE",
          label: this.$t("api_test.definition.request.create_info"),
        },
        ...
        {
          id: "ASSOCIATE_CASE",
          label: this.$t("test_track.review_view.relevance_case"),
        },
        {
          id: "ASSOCIATE_ISSUE",
          label: this.$t("test_track.case.relate_issue"),
        },
        ...
        {
          id: "CREATE_PRE_TEST",
          label: this.$t("api_test.create_performance_test"),
        },
        ...
        {
          id: "BATCH_DEL",
          label: this.$t("api_test.definition.request.batch_delete"),
        },
        {
          id: "BATCH_UPDATE",
          label: this.$t("api_test.definition.request.batch_edit"),
        },
      ...
      sysList: [
        {
          ...
          children: [
            ...
            { label: "迭代管理", value: "迭代管理", leaf: true },
  ...
  methods: {
    ...
    getProject() {
      ...
      this.result = this.$get(
        "/project/get/" + getCurrentProjectID(),
        (response) => {
