...
export const CUSTOM_TABLE_HEADER = {
  ...
  API_CASE: [
    ...
    },
    {
      ...
      key: "5",
      label:
        i18n.t("api_test.definition.request.case") +
  ...
  ISSUE_LIST: [
    ...
    { id: "title", key: "2", label: i18n.t("test_track.issue.title") },
    {
      id: "platformStatus",
      key: "3",
      label: i18n.t("test_track.issue.status"),
    },
    { id: "platform", key: "4", label: i18n.t("test_track.issue.platform") },
    {
      id: "creatorName",
      key: "5",
      label: i18n.t("custom_field.issue_creator"),
    },
    {
      id: "resourceName",
      key: "6",
      label: i18n.t("test_track.issue.issue_resource"),
    },
    {
      id: "description",
      key: "7",
  ...
  ITERATION_LIST: [
    { id: "name", key: "1", label: "迭代名称" },
    { id: "assignee", key: "2", label: "负责人" },
    { id: "status", key: "3", label: "当前状态" },
    { id: "schedule", key: "4", label: "迭代进度" },
    { id: "startTime", key: "5", label: "开始时间" },
    { id: "endTime", key: "6", label: "结束时间" },
    { id: "numberOfExecutions", key: "7", label: "执行次数" },
    { id: "lastPassRate", key: "8", label: "最后一次通过率" },
  ],
};
