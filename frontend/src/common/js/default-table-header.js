...
//接口用例
  ...
  ISSUE_LIST: [
    ...
    {id: 'platformStatus', key: '3', label: i18n.t('test_track.issue.platform_status')},
    {id: 'platform', key: '4', label: i18n.t('test_track.issue.platform')},
    {id: 'assigneeName', key: '5', label: i18n.t('test_track.issue.handler')},
    {id: 'description', key: '6', label: i18n.t('test_track.issue.description')},
    {id: 'caseCount', key: '7', label: i18n.t('test_track.issue.case_number')},
    {id: 'createTime', key: '8', label: i18n.t('test_track.issue.create_time')},
    {id: 'defectTypeName', key: '9', label: i18n.t('test_track.issue.defect_type')},
    {id: 'priority', key: 'a', label: i18n.t('test_track.issue.priority')},
    {id: 'workingHours', key: 'b', label: i18n.t('test_track.issue.working_hours')},
    {id: 'iterationName', key: 'c', label: i18n.t('test_track.issue.iteration')},
    {id: 'recordedHours', key: 'd', label: i18n.t('test_track.issue.working_hours_log')},
    {id: 'watcherName', key: 'e', label: i18n.t('test_track.issue.followers')},
    {id: 'startDate', key: 'f', label: i18n.t('test_track.issue.start_date')},
    {id: 'dueDate', key: 'g', label: i18n.t('test_track.issue.due_date')},
    {id: 'creatorName', key: 'h', label: i18n.t('test_track.issue.creator')},
    {id: 'requirementName', key: 'i', label: i18n.t('test_track.issue.related_requirements')},
    {id: 'model', key: 'j', label: i18n.t('test_track.issue.module')},
  ]
