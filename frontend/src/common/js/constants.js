...
export const JMETER_FUNC = [
  {
    type: "Information",
    name: "${__threadNum}",
    description: "get thread number",
  },
  {
    type: "Information",
    name: "${__samplerName}",
    description: "get the sampler name (label)",
  },
  {
    type: "Information",
    name: "${__machineIP}",
    description: "get the local machine IP address",
  },
  {
    type: "Information",
    name: "${__machineName}",
    description: "get the local machine name",
  },
  {
    type: "Information",
    name: "${__time}",
    description: "return current time in various formats",
  },
  {
    type: "Information",
    name: "${__log}",
    description: "log (or display) a message (and return the value)",
  },
  {
    type: "Information",
    name: "${__logn}",
    description: "log (or display) a message (empty return value)",
  },
  {
    type: "Input",
  ...
  },
  {
    type: "Input",
    name: "${__CSVRead}",
    description: "read from CSV definitioned file",
  },
  {
    type: "Input",
    name: "${__XPath}",
    description: "Use an XPath expression to read from a file",
  },
  {
    type: "Calculation",
    name: "${__counter}",
    description: "generate an incrementing number",
  },
  { type: "Calculation", name: "${__intSum}", description: "add int numbers" },
  {
    type: "Calculation",
    name: "${__longSum}",
    description: "add long numbers",
  },
  {
    type: "Calculation",
    name: "${__Random}",
  ...
  },
  {
    type: "Calculation",
    name: "${__UUID}",
    description: "generate a random type 4 UUID",
  },
  {
    type: "Scripting",
    name: "${__BeanShell}",
    description: "run a BeanShell script",
  },
  {
    type: "Scripting",
    name: "${__javaScript}",
    description: "process JavaScript (Mozilla Rhino)",
  },
  {
    type: "Scripting",
    name: "${__jexl}",
    description: "evaluate a Commons Jexl expression",
  },
  {
    type: "Scripting",
    name: "${__jexl2}",
  ...
  { type: "Properties", name: "${__property}", description: "read a property" },
  {
    type: "Properties",
    name: "${__P}",
    description: "read a property (shorthand method)",
  },
  {
    type: "Properties",
    name: "${__setProperty}",
    description: "set a JMeter property",
  },
  {
    type: "Variables",
    name: "${__split}",
    description: "Split a string into variables",
  },
  {
    type: "Variables",
    name: "${__V}",
    description: "evaluate a variable name",
  },
  {
    type: "Variables",
    name: "${__eval}",
    description: "evaluate a variable expression",
  },
  {
    type: "Variables",
    name: "${__evalVar}",
    description: "evaluate an expression stored in a variable",
  },
  {
    type: "String",
    name: "${__regexFunction}",
    description: "parse previous response using a regular expression",
  },
  {
    type: "String",
    name: "${__escapeOroRegexpChars}",
    description: "quote meta chars used by ORO regular expression",
  },
  {
    type: "String",
    name: "${__char}",
    description: "generate Unicode char values from a list of numbers",
  },
  {
    type: "String",
    name: "${__unescape}",
    description: "Process strings containing Java escapes (e.g. & )",
  },
  {
    type: "String",
    name: "${__unescapeHtml}",
    description: "Decode HTML-encoded strings",
  },
  {
    type: "String",
    name: "${__escapeHtml}",
    description: "Encode strings using HTML encoding",
  },
  {
    type: "String",
    name: "${__TestPlanName}",
    description: "Return name of current test plan",
  },
];
