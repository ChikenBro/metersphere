export default {
  ...
  workspace: {
    ...
    delete: "刪除工作空間",
    delete_confirm:
      "刪除該工作空間會關聯刪除該工作空間下的所有資源(如：相關項目，測試用例等），確定要刪除嗎?",
    add: "添加工作空間",
  ...
  organization: {
    ...
    delete: "刪除組織",
    delete_confirm:
      "刪除該組織會關聯刪除該組織下的所有資源(如：相關工作空間，項目，測試用例等），確定要刪除嗎?",
    input_name: "請輸入組織名稱",
    ...
    message: {
      ...
      lark: "飛書機器人",
      notes:
        "1.釘釘和企業群裏新建一個自定義機器人，然後復制 webhook 地址在我們平臺上;\n" +
    ...
    integration: {
      ...
      use_tip_zentao:
        "賬號密碼為具有相應權限的Zentao賬號，賬號需要具有 超級model調用接口權限",
      use_tip_two:
        "保存 Basic Auth 賬號信息後，需要在 MeterSphere 項目中手動關聯 ID/key 和缺陷模板",
  ...
  report: {
    ...
    project_name: "所屬項目",
    force_stop_tips:
      "<strong>強制停止</strong>測試會立刻結束當前測試並刪除報告數據",
  ...
  api_test: {
    ...
    copy: "復制測試",
    batch_add_parameter:
      "格式：參數名,必填,參數值,備註 <br/> 如：Accept-Encoding,必填,utf-8,編碼",
    jar_config: {
      title: "jar包管理",
      jar_file: "jar包",
    ...
    definition: {
      ...
      request: {
        ...
        esb_title:
          "可以在報文模板中使用${參數名} 或 ${父節點參數名.子節點參數名}來生成xml數據結構",
      },
      document: {
        order: "排序方式",
    ...
    automation: {
      ...
      loop_name: "循環",
      loop_content:
        "默認為開啟，當循環下只有一個請求時，可以開啟/關閉;當循環下超過一個請求時，則只能開啟。",
    ...
    request: {
      ...
      extract: {
        ...
        select_type: "請選擇類型",
        description:
          "從響應結果中提取數據並將其存儲在變量中，在後續請求中使用變量。",
        regex: "正則",
    ...
    api_import: {
      ...
      ms_export_tip:
        "通過 MeterSphere 接口測試頁面或者瀏覽器插件導出 json 格式文件",
  ...
  test_track: {
    ...
    case: {
      ...
      import: {
        ...
        click_upload: "點擊上傳",
        upload_limit: "只能上傳xls/xlsx文件，且不超過50M",
    ...
    plan_view: {
      ...
      component_library_tip:
        "拖拽組件庫中組件，添加至右側，預覽報告效果，每個系統組件只能添加一個。",
    ...
    issue: {
      ...
      search_name: "根據標題搜索",
      platform_tip:
        "在系統設置-組織-服務集成中集成缺陷管理平臺可以自動提交缺陷到指定缺陷管理平臺",
      input_title: "請輸入標題",
      id: "缺陷ID",
      title: "缺陷標題",
      description: "缺陷描述",
  ...
  test_resource_pool: {
    ...
    update_prompt:
      "{0}  等測試正在使用此資源池，禁用可能會影響報告的監控部分，是否繼續？",
