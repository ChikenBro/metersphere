export default {
  ...
  organization: {
    ...
    delete_confirm:
      "Deleting this organization will delete all resources (such as related workspaces, projects, test cases, etc.) under this organization. Are you sure you want to delete?",
    ...
    message: {
      ...
      notes:
        "1. Nail and create a custom robot in the enterprise group, and then copy the webhook address on our platform;\n" +
        "\n" +
      ...
      message_webhook:
        "Webhook is required when the receiving mode is nail or enterprise robot or lark",
      template: "Template",
    },
    integration: {
      ...
      use_tip_jira:
        "Jira software server authentication information is account password, Jira software cloud authentication information is account + token (account settings-security-create API token)",
      use_tip_zentao:
        "The account password is a Zentao account with corresponding permissions, and the account needs to have super model calling interface permissions",
      use_tip_two:
        "After saving the Basic Auth account information, you need to manually associate the ID/key and issue template in the MeterSphere project",
  ...
  report: {
    ...
    start_status:
      "The test is in the beginning state, we will automatically display it on the page after we generate the report!",
  ...
  test_track: {
    ...
    case: {
      ...
      upload_tip:
        "Only jpg, jpeg, png, docx, doc, pdf, xlsx, txt files can be uploaded",
    ...
    issue: {
      ...
      platform_tip:
        "Integrated defect management platform in the system setting-organization-service integration can automatically submit defects to the designated defect management platform",
    ...
    iteration: {
      iteration_management: "Iteration Management",
    },
    report: {
  ...
  schedule: {
    ...
    cron_expression_interval_short_error:
      "Interval time shorter than 3 minutes, please avoid running tests that take too long",
    cron: {
      seconds: "Seconds",
      minutes: "Minutes",
      hours: "Hours",
